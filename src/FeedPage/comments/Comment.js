...
import "./Comments.css"
function Comment({commentId, commentText ,commentAuthor ,remComment, postId, editComment , setCommentList}){
  const edditing = 0;


    return(
        <figure className="comments-class">
          <CommSettingsBtn remComment= {remComment} postId= {postId} commentId={commentId} setCommentList ={setCommentList}/>
